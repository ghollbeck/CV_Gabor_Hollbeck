...
\begin{document}
    ...
    \begin{header}
        \raggedright
        \fontsize{25 pt}{25 pt}\selectfont Gabor Hollbeck \hspace{1cm} \normalsize \hrefWithoutArrow{mailto:ghollbeck@ethz.ch}{ghollbeck@ethz.ch} \hspace{0.2cm} \hrefWithoutArrow{tel:+49-173-2328586}{+49 173 2328586} \hspace{0.2cm} \href{https://gaborhollbeck.com/}{gaborhollbeck.com}

        \vspace{5 pt}

        \normalsize
        Gabor is interested in computational social science, AI4Democracy applications and AI safety research.
        \par
    ...
    \begin{twocolentry}{
        ...
        \textbf{Research Collaboration}, Stanford University 

        \vspace{0.10 cm}
        \begin{onecolentry}
            \begin{highlights}
                \item Multiagent Equilibria in Game Theory simulations with Dr. Tobin South and Prof. Alex Pentland, No official affiliation due to recent administratvie visa issues
    ...
    \end{twocolentry}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Focusing on ML, Complex System Dynamics and Computational Social Science
            \end{highlights}
        \end{onecolentry}
 ...
 %        \vspace{0.2 cm}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \underline{\href{https://scienceos.co}{scienceos.co}} and \underline{\href{https://rigorous.review}{rigorous.review}}
            \end{highlights}
        \end{onecolentry}
...
\begin{twocolentry}{
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Awardwinning educational videos around theoretical computer science, $\sim$ 100K subscribers, 0.5 - 5M views/vid
            \end{highlights}
        \end{onecolentry}
    ...
    \section{Freelance Videography}
        ...
        \begin{onecolentry}{
            ...
            \textbf{Video Producer}, German Zero e.V. (carbon neutrality initiative) - produced cinema advertisement,
            \end{onecolentry}
