...
\begin{document}
    ...
    \section{Education}
        ...
        \begin{twocolentry}{
            ...
            \textbf{M.Sc. Physics}, ETH Zürich | Focus: SST Phase transitions, Statistical physics \& Complex system dynamics\end{twocolentry}
        ...
        \begin{twocolentry}{
            ...
            \textbf{B.Sc. Physics}, Universität Duisburg-Essen, GPA: 1.2/1.0, ranked first in cohort\end{twocolentry}
    ...
    \begin{twocolentry}{
        ...
        \href{https://comparativeglobalhumanities.mit.edu/people/gabor-hollbeck/}{\underline{\textbf{Research Pillar Coordinator}}}, Comparative Global Humanities Initiative @MIT with Prof. Wiebke Denecke and Prof. Otto Scharmer\end{twocolentry}
          ...
          \begin{onecolentry}
\begin{highlights}
    \item Research on two   projects: AI4Democracy \& Duolingo for conflict resolution
...
\end{onecolentry}
 ...
 \vspace{0.2 cm}
    ...
    \section{Coding Projects \& Initiatives }
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Think tank and part of of Alt Protein Projects, funded by the GFI (Good Food Institute), fostering the transformation of the way we produce food sustainably.  Recruiting and leading a team of 10+ people.
            \end{highlights}
        \end{onecolentry}
        ...
        \begin{twocolentry}{
            ...
            \textbf{Awardwinning Youtube Content Creator}, \href{https://www.youtube.com/@PolylogCS}{\underline{Polylog}} (YT Channel on theoretical CS, 0.5-5M views/vid)\end{twocolentry}
